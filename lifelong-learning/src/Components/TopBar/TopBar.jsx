                            ...
                            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                {isRecruiter() ? (
                                    <>
                                        ...
                                        <li>
                                            <Link to="/createapplication" className="block py-2 pl-3 pr-4 text-white rounded hover-gold-yellow md:hover:bg-transparent md:hover:text-blue-700 md:p-20 dark:text-white md:dark:hover:text-blue-500 dark:hover-gold-yellow dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">CREATE APPLICATION</Link>
                                        </li>
                                    </>
                                ) : (
                                    <>

...
const jobDetails = {
    logo: '/path/to/logo.png', // Replace with the path to your logo asset
    title: 'Software Developer',
    company: 'City Hall Pty Ltd',
    type: 'Full Time',
    location: 'New York, NY',
    salary: '$70,000 - $90,000',
    tags: ['Entry Level', 'Tech', 'Urgent'], // Add tags as needed
};
...
export default function ApplicationPage() {
    ...
    const handleJobClick = (jobpostingid) => {
        ...
        navigate(`/applicationview/${jobpostingid}`); // Use backticks (`) for string interpolation
    };
